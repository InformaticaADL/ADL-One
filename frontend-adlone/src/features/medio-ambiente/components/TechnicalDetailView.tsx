    ...
    useEffect(() => {
        const loadFicha = async () => {
            ...
            try {
                ...
                if (fichaData && fichaData.observaciones && fichaData.observaciones.tecnica) {
                    setTecnicaObs(fichaData.observaciones.tecnica);
                }
            } catch (error) {
                ...
                <div className="tab-content-area" style={{ display: 'block' }}>
                    ...
                    {activeTab === 'observaciones' && (
                        <div style={{ display: 'grid', gap: '2rem' }}>
                            ...
                            <ReadOnlyObservationArea label="Observaciones Coordinación" value={obs.coordinador} />
                        </div>
                    )}
