-- ============================================================
-- Setup: Eventos de notificación para Fichas de Muestreo
-- Crea o actualiza FICHA_ASIGNADA, FICHA_MUESTREO_REPROGRAMADO, FICHA_MUESTREO_CANCELADO
-- Usa {servicios_detalle} como placeholder (no {EQUIPOS_DETALLE})
-- ============================================================
