...
export const FICHA_CONFIG = [
    ...
    {
        codigo: 'FICHA_INFORME_COMPLETO',
        categoria: 'FICHA',
        outcome: 'APROBADA',
        asunto: 'Informe Completo: Ficha #{CORRELATIVO}',
        titulo: 'Informe Completo',
        resumen: 'Todos los resultados del servicio de la ficha #{CORRELATIVO} ya están cargados. Queda disponible para facturar.',
        campos: FICHA_CAMPOS_BASE,
        eventoMeta: EVENTO_META,
        cta: CTA_EJECUTADOS,
    },
    {
        codigo: 'FICHA_CICLO_FINALIZADO',
        categoria: 'FICHA',
        outcome: 'APROBADA',
        asunto: 'Ciclo Finalizado: Ficha #{CORRELATIVO}',
        titulo: 'Ciclo de la Ficha Finalizado',
        resumen: 'Todos los servicios programados de la ficha #{CORRELATIVO} ya tienen su informe completo.',
        campos: FICHA_CAMPOS_BASE,
        eventoMeta: EVENTO_META,
        cta: CTA_FICHA,
    },
